...
interface GroupModalProps {
    // FIX: Use '$id' to match the GradeSheet type from types.ts
...
const GroupModal: React.FC<GroupModalProps> = ({ sheet, onClose, onSave }) => {
    ...
    const handleSubmit = (e: React.FormEvent) => {
        ...
        // FIX: Use '$id' to check if editing an existing sheet.
...
const GroupManagement: React.FC<GroupManagementProps> = ({ setPage }) => {
    ...
    const handleFileChange = (event: React.ChangeEvent<HTMLInputElement>) => {
        ...
        reader.onload = (e) => {
            ...
            for (let i = 1; i < json.length; i++) {
                ...
                // FIX: Use '$id' in the Omit type to match the GradeSheet type.
    ...
    // FIX: Use '$id' to correctly type the 'data' parameter and check for existence.
                        ...
                        {gradeSheets.length > 0 ? (
                            <ul className="divide-y divide-gray-200">
                                {gradeSheets.map(sheet => (
                                    // FIX: Use sheet.$id for the key property.
                                    <li key={sheet.$id} className="py-3 flex items-center justify-between">
                                        ...
                                        <div className="space-x-2">
                                            ...
                                            {/* // FIX: Pass sheet.$id to the delete handler. */}
