...
// Appwrite Constants
export const APPWRITE_DATABASE_ID = 'cs0025db';
export const APPWRITE_USERS_COLLECTION_ID = 'users';
export const APPWRITE_GRADESHEETS_COLLECTION_ID = 'gradeSheets';
export const APPWRITE_VENUES_COLLECTION_ID = 'venues';
